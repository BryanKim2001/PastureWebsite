        ...
        <section className="py-32">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              <div className="mb-12">
                <svg className="w-24 h-24 mx-auto text-green-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                href="/visit"
                className="inline-block bg-green-700 text-white px-8 py-4 hover:bg-emerald-700 transition text-lg"
              >
                Plan Your Visit
              </Link>
            </div>
