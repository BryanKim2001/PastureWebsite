      ...
      <main className="bg-stone-50">
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8 text-lg text-stone-600 leading-relaxed">
                <p>
                  In the Reformed tradition, we understand giving as a joyful response to God's overwhelming grace
                ...
                <div className="bg-white p-10 shadow-soft">
                  <p className="mb-6">
                  ...
                  <div className="border-l-4 border-emerald-600 pl-6 italic text-stone-700">
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-10">
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-semibold mb-3 text-stone-900">Discipleship</h4>
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-semibold mb-3 text-stone-900">Missions</h4>
                  <p className="text-stone-600 leading-relaxed">
                    Funding local and global mission work, supporting church planters and missionaries
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-semibold mb-3 text-stone-900">Fellowship</h4>
                  <p className="text-stone-600 leading-relaxed">
        ...
        <section className="py-24">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-white p-12 shadow-soft text-center">
                <h3 className="text-2xl font-semibold mb-4 text-stone-900">Give via Venmo</h3>
                <p className="text-lg text-stone-600 mb-10">
                  You can support The Pasture's ministry through Venmo
                </p>

                <div className="bg-stone-50 p-10 mb-10">
                  <p className="text-stone-600 mb-4">Send your gift to:</p>
                  <div className="bg-emerald-50 p-8 inline-block">
                    <p className="text-4xl font-bold text-emerald-700 mb-1">@ILSHINCHURCH</p>
                    <p className="text-sm text-stone-600">Venmo Username</p>
                  </div>
                </div>
                ...
                <a
                  ...
                  className="inline-block bg-emerald-600 text-white px-10 py-4 hover:bg-emerald-700 transition text-lg mb-10"
                >
                  Open in Venmo
                </a>
        ...
        <section className="py-20 bg-emerald-600 text-white">
          <div className="container mx-auto px-6 text-center max-w-3xl">
            ...
            <p className="text-lg opacity-90">Proverbs 3:9-10</p>
          </div>
        </section>
      </main>
      <Footer />
