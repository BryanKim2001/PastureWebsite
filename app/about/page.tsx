          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-16">
                <div>
                  <h3 className="text-2xl font-semibold mb-4 text-emerald-600">Our Background</h3>
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-4 text-emerald-600">Our Vision</h3>
                  <p className="text-lg text-stone-600 leading-relaxed">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-4 text-emerald-600">Our Mission</h3>
                  <p className="text-lg text-stone-600 leading-relaxed">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white p-12 shadow-soft">
                <div className="flex items-start space-x-6 mb-8">
                  <div className="bg-emerald-50 p-4 flex-shrink-0">
                    <svg className="w-10 h-10 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-2xl font-semibold mb-4 text-stone-900">Presbyterian Church in America (PCA)</h3>
                    ...
                    <a
                      ...
                      className="inline-flex items-center space-x-2 text-emerald-600 hover:text-emerald-700 transition font-medium"
                    >
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-5 gap-12 items-start">
                ...
                <div className="md:col-span-3">
                  ...
                  <p className="text-emerald-600 font-medium mb-8 text-lg">Lead Pastor</p>
